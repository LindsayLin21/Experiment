...
config.dataset.valid_split = 0.1 # percent of train/validation dataset split
# select data
config.dataselect.mode = '' # random, byclass
config.dataselect.per_random = 0.5
config.dataselect.classes = []
